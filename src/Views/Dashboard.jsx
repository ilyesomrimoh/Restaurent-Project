  ...
  return (
    <div className='flex h-screen bg-gray-200'>
        ...
        <div className="flex-1 p-4">
          {user && <h1 style={{textAlign : 'center', width: '100%', height: '100vh',paddingTop: '20vh'}}>Welcome to your Dashboard <span className='red-text' >{user.email}</span> {user.displayName && `your name is ${user.displayName}`}</h1>}
