...
<div class="w-[250px] h-[370px]  bg-white border  rounded-xl shadow  relative">
<div class="flex  justify-end w-full px-4 pt-4 absolute z-10">
    ...
    <a href="#">
        <img className='h-44 w-72 bg-cover rounded-t-xl brightness-90' class="rounded-t-lg" src="/images/Assets/food.jpg" alt="" />
    </a>
    <div class="p-5">
        <a href="#">
            <h5 class="mb-2 text-base font-bold tracking-tight text-gray-900 ">Noteworthy technology acquisitions </h5>
        </a>
        ...
        <button type="button" class="text-[var(--primary-color)] hover:text-white border border-[var(--primary-color)] hover:bg-[var(--primary-color)]  font-medium rounded-lg text-sm px-4 py-[3px] text-center ">Edit</button>
        </div>
        <p class="mb-3 font-normal text-[13px] text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
