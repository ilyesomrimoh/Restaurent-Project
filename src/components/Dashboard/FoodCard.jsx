...
<div className="w-[250px] h-[370px]  bg-white border  rounded-xl shadow  relative">
<div className="flex  justify-end w-full px-4 pt-4 absolute z-10">
        ...
        {showDrop && ( <div id="dropdown" className="z-10 absolute top-[58px] text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 ">
            ...
            <li>
                <a href="#" className="block px-4 py-2 text-sm   hover:bg-[var(--primary-color)]  hover:text-white">Edit</a>
            </li>
            <li>
    ...
    <div className="p-5">
        ...
        <button type="button" className="text-[var(--primary-color)] hover:text-white border border-[var(--primary-color)] hover:bg-[var(--primary-color)]  font-medium rounded-lg text-sm px-4 py-[3px] text-center ">Edit</button>
        </div>
