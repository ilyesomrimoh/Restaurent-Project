...
const OverviewCard = ({title ,content}) => {
  return (
    <div className='flex justify-between items-center gap-4 bg-white w-72 h-43 rounded-xl p-5 pb-8 pt-8 shadow-lg transition-transform delay-300 hover:scale-105'>
